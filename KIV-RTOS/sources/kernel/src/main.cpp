...
extern "C" unsigned char __semestral_task[];
extern "C" unsigned int __semestral_task_len;
...
extern "C" int _kernel_main(void)
{
	...
	sProcessMgr.Create_Process(__semestral_task, __semestral_task_len, false);
